...
export default function InquiryPage() {
    ...
    return (<>
        ...
        <div className='mt-20 container mx-auto pb-4 flex flex-col'>
                    ...
                    <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
                        <div>
                            ...
                            <p className="mb-6 text-gray-600 leading-relaxed">
                                Strides Design is a leading exhibition stall design and fabrication company
                                specializing in custom exhibition stall design, exhibition stand fabrication,
                                and exhibition stand construction for trade shows, expos, and corporate events.
                                As a trusted Exhibition Design Agency, we help brands create high-impact
                                exhibition spaces that attract visitors, enhance brand visibility, and
                        ...
                        <div>
                            ...
                            <ul className="space-y-4 text-gray-700">
                                <li className="flex items-start gap-3">
                                    ...
                                    <span>
                                        <strong className='text-lg'>Domestic Exhibition Stall Designing:</strong> Creative and high-impact
                                        exhibition stall designs tailored for brands across India.
                                    </span>
                                </li>
                                ...
                                <li className="flex items-start gap-3">
                                    <span className="mt-2.5 h-2 w-3 rounded-full bg-[#039C98]" />
                                    <span>
                                        <strong className='text-lg'>Exhibition Fabrication Services:</strong> High-quality stand fabrication
                                        with precision, durability, and premium finishing.
                                    </span>
                                </li>
                                ...
                                <li className="flex items-start gap-3">
                                    <span className="mt-2.5 h-2 w-3 rounded-full bg-[#039C98]" />
                                    <span>
                                        <strong className='text-lg'>Corporate Event Management:</strong> End-to-end planning and execution
                                        of conferences, meetings, and corporate gatherings.
                                    </span>
                                </li>
                                ...
                                <li className="flex items-start gap-3">
                                    <span className="mt-2.5 h-2 w-3 rounded-full bg-[#039C98]" />
                                    <span>
                                        <strong className='text-lg'>Brand Activation:</strong> Innovative activation strategies to engage
                                        audiences and boost brand visibility.
                                    </span>
                                </li>
                                ...
                                <li className="flex items-start gap-3">
                                    <span className="mt-2.5 h-2 w-3 rounded-full bg-[#039C98]" />
                                    <span>
                                        <strong className='text-lg'>Product Launch:</strong> Strategic and visually powerful product launch
                                        events that create lasting market impact.
                                    </span>
                                </li>
                            </ul>
            ...
            {/* CTA */}
            <div className="relative flex flex-col mx-4 items-start mt-5 justify-between gap-8 rounded-2xl bg-[#039C98] px-8 py-10 md:flex-row md:items-center" id='contact'>
                <div>
                    ...
                    <p className="mt-2 max-w-xl text-sm text-white/90 md:text-lg">
                        Partner with Strides Design to create custom exhibition stands that attract, engage, and convert visitors into customers.
                    </p>
                </div>
